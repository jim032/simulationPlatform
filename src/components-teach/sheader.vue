	...
	<div class="headerbox" ref="header">
		...
		<div class="funbox">
			<div class="hed-fun-box" :class="{'fadeIn':isOperate}">
				<a class="btn btn_console" v-if="consoleShow"><span></span><em>Console</em></a>
				<a class="btn btn_reset" @click="Pagereload " v-if="courseId!=1 && showReset==true"><span></span><em>Reset</em></a>
				<a class="btn btn_back" @click="back"><span></span><em>Return</em></a>
			</div>
