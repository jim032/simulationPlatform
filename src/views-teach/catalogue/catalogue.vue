  ...
  <div class="pageWrap homePageWrap" ref="pageWrap">
    <div class="headerFun">
      <div class="hed-fun-box" :class="{ fadeIn: isOperate }">
        <a class="btn btn_console" @click="linkConsole"
          ><span></span><em>Console</em></a
        >
    ...
    <div class="cataBox" ref="cataBox">
      <div class="cataMain" :class="{ 'cataMain-4': isTab4 }">
        <div class="cata-main">
          <div
            class="pcat pcat1 cursorPoint"
            @click="linkSubCatalog(catlog1.id, catlog1.title)"
            v-if="catlog1.title != ''"
          >
            ...
            <div class="intro">
              <img
                class="introIcon"
                src="../../assets/teachImg/cat_icon1.png"
              />
          ...
          <div
            class="pcat pcat2 cursorPoint"
            @click="linkSubCatalog(catlog2.id, catlog2.title)"
            v-if="catlog2.title != ''"
          >
            <img src="../../assets/teachImg/circle.png" />
            <div class="intro">
              <img
                class="introIcon"
                src="../../assets/teachImg/cat_icon2.png"
              />
              <p class="pt">{{ catlog2.title }}</p>
            </div>
          </div>
          <div
            class="pcat pcat-zdy cursorPoint"
            :style="model == 2 ? 'width:auto' : ''"
            @click="linkCustCatalog"
            v-if="!isTab4 || model == 2"
          >
            <img src="../../assets/teachImg/circle.png" />
            <div class="intro">
              <img
                class="introIcon"
                src="../../assets/teachImg/cat_icon5.png"
              />
              <p class="pt">{{ catlog5.title }}</p>
            </div>
          </div>
          <div
            class="pcat pcat-yl pcat1 cursorPoint"
            @click="linkSubCatalog(catlog3.id, catlog3.title)"
            v-if="catlog3.title != ''"
          >
            <img src="../../assets/teachImg/circle.png" />
            <div class="intro">
              <img
                class="introIcon"
                src="../../assets/teachImg/cat_icon3.png"
              />
              <p class="pt">{{ catlog3.title }}</p>
            </div>
          </div>
          <div
            class="pcat pcat-yl pcat2 cursorPoint"
            @click="linkSubCatalog(catlog4.id, catlog4.title)"
            v-if="catlog4.title != ''"
          >
            <img src="../../assets/teachImg/circle.png" />
            <div class="intro">
              <img
                class="introIcon"
                src="../../assets/teachImg/cat_icon4.png"
              />
  ...
  methods: {
        ...
        if (res.code == 200) {
          ...
          for (let i = 0; i < tmpArray.length; i++) {
            if (
              loginModal &&
              loginModal == 1 &&
              tmpArray[i].id == "e72d3a24-f983-11ea-adc1-0242ac120002"
            ) {
              //console.log('单人模式')
            ...
            if (
              loginModal &&
              loginModal == 2 &&
              tmpArray[i].id == "e72d3a88-f983-11ea-adc1-0242ac120002"
            ) {
              //temp = res.data[i].children;
              temp = [];
            }
    ...
    showCat(num) {
      ...
      if (that.catalogNum == num) {
        ...
        $(".homePageWrap")
          .stop()
          .animate({ height: that.boxheight }, 500);
      } else {
        that.catalogNum = num;
        if (!that.index) {
          $(".cataMain")
            .stop()
            .animate({ "padding-bottom": "0" }, 500);
        }
        if (num == 3 || num == 4) {
          $(".cataMain")
            .stop()
            .animate({ "padding-bottom": "100px" }, 500);
        } else {
          $(".cataMain")
            .stop()
            .animate({ "padding-bottom": "0" }, 500);
    ...
    linkCustCatalog() {
      ...
      if (that.courseList.length > 0) {
        ...
        that.$toast("No multiplayer courses", 3000);
      }
    },
    //点击跳转控制台
    linkConsole() {
...
.pageWrap {
  background: url(../../assets/teachImg/index_bg.png) center no-repeat;
  overflow: auto;
  ...
  .headerFun {
    ...
    .icon {
      ...
      display: block;
      margin: 0 auto;
      background: url(../../assets/teachImg/simu_exit.png) center no-repeat;
      background-size: cover;
      -webkit-background-size: cover;
    }
    em {
    ...
    .bback {
      ...
      height: 36px;
      display: inline-block;
      background: url(../../assets/teachImg/hed_arrow.png) center no-repeat;
    ...
    .btn_console span {
      ...
      display: block;
      margin: 0 auto;
      background: url(../../assets/teachImg/btn_console.png) center no-repeat;
      background-size: cover;
      -webkit-background-size: cover;
    }
    .btn_console em {
