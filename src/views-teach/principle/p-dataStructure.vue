		...
		<div class="mainContent">
			 ...
			 <div class="data-box">
			 	 ...
			 	 <div class="d-col d-box2" v-if="showContent">
			 	 	  <div ><img src="../../assets/teachImg/block_main.png"/></div>
			 	 </div>
			 </div> 
		</div>
...
<script src="../../function/p-dataStructure.js"></script>
<style scoped lang="less">
	@import url("../../assets/teachCss/p-keyStore.less");
	.d-col{display: inline-block; text-align: center;}
	.data-box{text-align: center; font-size:0px;width:1400px; margin: 0 auto;}
	.d-box1{width: 25%;height: 100%;}
	.d-box2{width:80%; overflow: hidden;position: relative;
	 }
	.data-box img{max-width:100%;}
	.d-box2 div{padding-top: -40px; }
	
	@media only screen and (max-width: 1400px ) {
		.data-box{width:90%; margin: 0 40px;}
	}
</style>
