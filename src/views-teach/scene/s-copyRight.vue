      ...
      <div class="operaBpox">
        ...
        >
          <div class="bg">
            ...
            <div class="cr_din">
              <span class="lab">Registered name:</span>
              <div>
                <i-input
                  placeholder=""
            ...
            <div class="cr_din">
              <span class="lab">Creative note:</span>
              <div>
                <i-input
                  placeholder=""
                  type="textarea"
            ...
            <div class="com-btnBox">
              <a class="com-btn" @click="funstep1">on the chain</a>
            </div>
          </div>
        </div>
        ...
        >
          <div class="bg">
            ...
            <div class="userInfo">
              <p class="pTitle">Copyright information</p>
              <p class="result-p">Registered name:{{ rgisteInfo.name }}</p>
              <p class="result-p">Copyright type:{{ rgisteInfo.workTitle }}</p>
          ...
          <div class="bg">
            ...
            <div class="info" v-if="searchStep == 1">
              <p class="result-p">
                ...
                &nbsp;&nbsp;&nbsp;Registrant registers copyright information
              </p>
              <p class="result-p">Registered name:{{ rgisteInfo.name }}</p>
              <p class="result-p">Copyright type:{{ rgisteInfo.workTitle }}</p>
              <p class="result-p">ID number：{{ rgisteInfo.id }}</p>
            ...
            <div class="info" v-if="searchStep == 2">
              <p class="result-p" v-if="searchStep == 2">
                ...
                &nbsp;&nbsp;&nbsp;Publishing House's evidence on the chain
              </p>
              <p class="result-p">Registered name:{{ rgisteInfo.name }}</p>
              <p class="result-p">Copyright type:{{ rgisteInfo.workTitle }}</p>
              <p class="result-p">ID number：{{ rgisteInfo.id }}</p>
