		   	  	 	   ...
		   	  	 	   <a class="sback" @click="stepBack"></a>
		   	  	 	   	<div class="cr_din">
		   	  	 	   	  <span class="lab">企业名称：</span>
		   	  	 	   	   <div><i-input  placeholder="" v-model="rgisteInfo.bussinessName" maxlength="20"></i-input></div>
		   	  	 	   </div>
		   	  	 	   <div class="cr_din">
		   	  	 	    ...
		   	  	 	    <div class="cr_din">
		   	  	 	   	  <span class="lab">法人证件：</span>
		   	  	 	   	   <div><i-input  placeholder="" v-model="rgisteInfo.id" maxlength='18'></i-input></div>
		   	  	 	   </div>
		   	  	 	    <div class="cr_din">
		   	  	 	   	  <span class="lab">融资金额：</span>
		   	  	 	   	   <div><i-input  placeholder="" v-model="rgisteInfo.financeAmount" maxlength='18'></i-input></div>
		   	  	 	   </div>
		   	  	 	   <div class="cr_din">
		   	  	 	   	  <span class="lab">合同编号：</span>
		   	  	 	   	   <div><i-input  placeholder="" v-model="rgisteInfo.contractNo" maxlength='18'></i-input></div>
		   	  	 	   </div>
		   	  ...
		   	  <!--登记完点击出版社-->
		   	   <div class="opr-col cr-main resultBox" v-if="step==2 &&　showNav==false && chainFinsh==false">
		   	  	 <div class="bg"> 
		   	  	 	   ...
		   	  	 	   <div class="userInfo">
		   	  	 	   	  <p class="pTitle">供应商</p>
		   	  	 	   	  <p class="result-p">企业名称：{{rgisteInfo.bussinessName}}</p>
		   	  	 	   	  <p class="result-p">法人姓名：{{rgisteInfo.name}}</p>
		   	  	 	   	  <p class="result-p">法人证件：{{rgisteInfo.id}}</p>
		   	  	 	   	  <p class="result-p">融资金额：{{rgisteInfo.financeAmount}}</p>
		   	  	 	   	  <p class="result-p">合同编号：{{rgisteInfo.contractNo}}</p>
		   	  	 	   </div>
		   	  ...
		   	  <div class="opr-col cr-main resultBox searchResult" v-if="searchStep!=0 && showNav==false">
		   	  	 <div class="bg">
		   	  	  	 ...
		   	  	  	 <div class="info" v-if="searchStep==1">
		   	  	  	 	  <p class="result-p" >{{rgisteInfo.time | formatDate }} &nbsp;&nbsp;&nbsp;{{rgisteInfo.bussinessName}}供应商上链</p>
		 		   	  	 	  <p class="result-p">企业名称：{{rgisteInfo.bussinessName}}</p>
		   	  	 	   	  <p class="result-p">法人姓名：{{rgisteInfo.name}}</p>
		   	  	 	   	  <p class="result-p">法人证件：{{rgisteInfo.id}}</p>
		   	  	 	   	  <p class="result-p">融资金额：{{rgisteInfo.financeAmount}}</p>
		   	  	  	 ...
		   	  	  	 <div class="info" v-if="searchStep==2">
		   	  	  	 	  <p class="result-p" v-if="searchStep==2">{{press.time | formatDate }} &nbsp;&nbsp;&nbsp;核心企业存证上链</p>
		   	  	 	   	  <p class="result-p">企业名称：{{rgisteInfo.bussinessName}}</p>
		   	  	 	   	  <p class="result-p">法人姓名：{{rgisteInfo.name}}</p>
		   	  	 	   	  <p class="result-p">法人证件：{{rgisteInfo.id}}</p>
		   	  	 	   	  <p class="result-p">融资金额：{{rgisteInfo.financeAmount}}</p>
