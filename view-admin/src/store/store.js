...
var store = new Vuex.Store({
    ...
    node_stepTips: [ //节点步骤提示
		...
		[//步骤提示
		  ...
		  {step:2,infolist:['1.提示用户点击左侧工具 内的设置按钮进行币种的 设置操作。','2.提示用户待设置币种完 成后，点击设置用户，到 底部状态栏进行查看该用 户新币种的一些信息。','3.其他其他其他其他其他 其他其他其他其他其他其 其他其他其他其他其他其 其他其他其他。']},
		  {step:3,
		...
		[//步骤提示
		  {step:0,infolist:
	  	  ['1、点击左侧工具箱“生成哈希”，通过哈希计算为“文件A”生成哈希值。',
	  	    '2、点击左侧工具箱的发送按钮，由用户A向用户B发送“文件A”。在文件发送过程中，你可以选择让文件受到外部攻击，或不攻击，来体验“文件A”受到篡改或未被篡改前后对哈希值的影响。',
	  	    '3、点击左侧工具箱的校验按钮，对“文件A”的哈希值进行校验。'
	  	  ]
		  },
		...
		//椭圆线
		ecc__stepTips:[{step:1,infolist:['1、点击左侧工具箱的生成按钮，尝试生成一段椭圆线。利用椭圆线算法可以生成公私钥。',
		'2、点击左侧工具箱的发送按钮，由用户A向用户B发送一段公钥加密数据。','3、点击左侧工具箱的解析按钮，由用户B使用自己的私钥对数据进行解密。']}],
